module.exports = {
  ...
  translation: {
    ...
    "smt": {
      ...
      professionalText: [ 'Senior engineer team, advanced equipment and environment to make perfect products and customer experience.' ],
      economy: [ 'Best Cost Performance' ],
      economyText: [ 'Best suitable suppliers and manufacturers to meet our client needs for cost reduction and better performance. ' ],
      ...
      paoh1: [ '1. According to your requirements, fill in the following information and the system will calculate the relevant price' ],
      paoh2: [ '2. Ordering applied less than 1000 sets of small quantities. For large quantities please use Online Quotation with discount' ],
      paoh3: [ '3. Extra fees cannot be calculated accurately. These fees are depends on their difficulties' ],
      paoh4: [ '4. Please use Online Quotation for requirment which has pcs larger than 500.' ],
      ...
      paBgaPointError: [ 'Please input correct BGA Points' ],
      paDipPoint: [ 'DIP Feet' ],
      paDipPointHint: [ 'one plugin foot = one DIP foot' ],
      paDipPointError: [ 'Please input correct DIP Points' ],
      ...
      pacdTitle: [ '* Client shall provide following documents:' ],
      pacd1: [ 'Detailed and accurate BOM list, if any changes are indicated on BOM (required)' ],
      pacd2: [ 'Gerber file, imposition of steel net, please provide the imposition file' ],
      pacd3: [ 'Component location code map (Reference Designator)' ],
      pacd4: [ 'Coordinate file (Pick Place file)' ],
      pacd5: [ 'PCB file (if coordinate file, location code map, Gerber file cannot be exported, please provide PCB file)' ],
      pacd6: [ 'Model sample（For production process. Optional）' ],
      parmcTitle: [ '* Primary material and losses:' ],
      parmc1: [ 'For samples or small batch order: one single product batch is less than or equal to 500PCS (excluding the loss as far as possible to provide spare parts according to the above 5%), IC and other precious materials are not included, as much as possible to 2-3pcs PCB' ],
      parmc2: [ 'First batch order (>500pcs) loss:' ],
